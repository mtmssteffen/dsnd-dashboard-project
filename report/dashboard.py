...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        ecounts = model.event_counts(entity_id)
        
        # Use the pandas .fillna method to fill nulls with 0
        ecounts = ecounts.fillna(0)
        
        # User the pandas .set_index method to set
        # the date column as the index
        ecounts.set_index('event_date', inplace=True)
        
        # Sort the index
        ecounts.sort_index(inplace=True)
        
        # Use the .cumsum method to change the data
        # in the dataframe to cumulative counts
        ecounts = ecounts.cumsum()
        
        
        # Set the dataframe columns to the list
        # ['Positive', 'Negative']
        ecounts.columns = ['Positive', 'Negative']
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        # learning model
        mdata = model.model_data(entity_id)
